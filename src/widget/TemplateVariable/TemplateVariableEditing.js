...
export default class TemplateViewEditing extends Plugin {
  static get requires() {
    return [Widget];
  }
  ...
  init() {
    ...
    this.editor.editing.mapper.on(
      ...
      viewToModelPositionOutsideModelElement(this.editor.model, (viewElement) =>
        viewElement.hasClass("template-variable")
      )
    );
  }
  ...
  _defineConverters() {
    ...
    function createTemplateVariableView(modelElement, viewWriter) {
      ...
      const templateVariableView = viewWriter.createContainerElement("span", {
